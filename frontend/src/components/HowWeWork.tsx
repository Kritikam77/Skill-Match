...
const HowWeWork = () => {
  ...
  return (
    <div
      ...
      className="flex flex-col bg-bgColor-light h-[50vh] md:h-[100vh] w-full z-30"
      style={{
        // transform: `translateY(-${translate}px)`,
      }}
    >
      <div className="m-auto font-oswald text-[5vh] md:text-[10vh] font-extrabold">
        HOW WE WORK
      </div>
      <div className="grid grid-cols-[30%_30%_30%] justify-around w-[95%] m-auto">
        <div className=" flex flex-col">
          <img src={ok} className="h-[10vh] md:h-[30vh] m-auto" />
          <div className="text-center font-oswald text-[2vh]">
            Search for a service based on location and skills.
          </div>
        </div>

        <div className=" flex flex-col">
          <img src={book} className="h-[10vh] md:h-[30vh] m-auto" />
          <div className="text-center font-oswald text-[2vh]">
        ...
        <div className=" flex flex-col">
          <img src={search} className="h-[10vh] md:h-[30vh] m-auto" />
          <div className="text-center font-oswald text-[2vh]">
